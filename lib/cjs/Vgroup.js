...
exports.vgroup = void 0;
const Vcontrol_1 = require("./Vcontrol");
class vgroup {
    constructor(Vcontrols) {
        ...
        for (const i in Vcontrols) {
            this.group[i] = new Vcontrol_1.vcontrol(Vcontrols[i].defaultVal, Vcontrols[i].element, Vcontrols[i].opts);
            this.state.value[i] = "";
